...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Memeup.Api.Domain.Auth.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.OwnsMany("Memeup.Api.Domain.Tasks.TaskOption", "Options", b1 =>
                        {
                            ...
                            b1.ToTable("TaskOptions", (string)null);
            ...
            modelBuilder.Entity("Memeup.Api.Domain.Auth.RefreshToken", b =>
                {
                    b.HasOne("Memeup.Api.Domain.Auth.ApplicationUser", "User")
                        .WithMany()
